package com.example.kmp_social_app.presentation.post_detail.components
...
import ru.sobeninalex.utils.compose.CommentListItem
...
fun LazyListScope.postDetailCommentsBlock(
    ...
    if (comments.isEmpty() && !isLoading) {
        ...
        itemsIndexed(
            ...
            ru.sobeninalex.utils.compose.CommentListItem(
                modifier = Modifier.animateItem(),
                comment = item,
