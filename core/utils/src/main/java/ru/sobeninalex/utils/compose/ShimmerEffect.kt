...
import ru.sobeninalex.resources.BlackColor10
...
fun Modifier.shimmerLinearGradient(): Modifier = composed {
    val waveColor: Color = if (isSystemInDarkTheme()) ru.sobeninalex.resources.WhiteColor50 else ru.sobeninalex.resources.BlackColor10
